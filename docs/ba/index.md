...
| ✔️       | BombArena         |                                     | [🔗](https://ci.battleplugins.org/job/BattlePlugins/job/BombArena/) |        | `@Europia79` | ![GitHub last commit](https://img.shields.io/github/last-commit/battleplugins/BombArena.svg?color=blue&label=Update&logo=github&logoColor=white&style=flat-square)      |
...
| ✔️       | ArenaTowerRush    |                                     | [🔗](https://ci.battleplugins.org/job/BattlePlugins/job/ArenaTowerRush/) |  🔗  | `@Redned` | ![GitHub last commit](https://img.shields.io/github/last-commit/battleplugins/ArenaTowerRush.svg?color=blue&label=Update&logo=github&logoColor=white&style=flat-square) |
...
| ✔️       | ArenaParkour      |                                     | [🔗](https://ci.battleplugins.org/job/BattlePlugins/job/ArenaParkour/) |        | `@alkarinv, @Redned` | ![GitHub last commit](https://img.shields.io/github/last-commit/battleplugins/ArenaParkour.svg?color=blue&label=Update&logo=github&logoColor=white&style=flat-square)   |
